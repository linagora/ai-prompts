...
const emailTestCases = [
  {
    ...
    input: {
      username: 'Benjamin ANDRE',
      email: 'ptranvan@linagora.com',
  ...
  },
  {
    ...
    input: {
      ...
      to: 'ptranvan@linagora.com',
      subject: 'Paul Testez votre maturité cloud en 4 minutes!',
      body: `Bonjour Paul, Migrer vers le Cloud Atlassian ne se résume plus à un simple projet technique. Accédez à une vision claire et personnalisée de votre trajectoire Cloud via notre simulateur intelligent.`
    },
    expectedOutput: { labels: [] }
  },
  {
